...
<div class="main-oneform" >
  ...
  <div class="container-fluid p-0">
    <div class="main-oneform__content">
      ...
      <div class="main-oneform__item">
        <form method="POST" action="https://nivel.activehosted.com/proc.php" id="_form_25_" class="_form _form_25 _inline-form  _dark" novalidate>
          ...
          <div class="_form-content _form-content--grid">
            ...
            <div class="_form-content__item">
              ...
              <div class="btn-formone__content">
                <button id="_form_25_submit" class="btn_custom btn--small btn--filled" type="submit">
                  Enviar
                </button>
              </div>
            </div>
