<section id="contacto" class="main-twoform">
  <div class="">
    <div class="main-twoform__content">
      <div class="main-twoform__item position-form-relative">
        <div class="main-title__general main-title__general--small container-fluid position-form" >
          <p>
              Quiero recibir  <br>
      ...
      <div class="main-twoform__item">
        <form method="POST" action="https://nivel.activehosted.com/proc.php" id="_form_27_" class="_form _form_27 _inline-form  _dark" novalidate>
          ...
          <div class="_form-content">
            ...
            <div class="main-contact__btnbox">
              <button id="_form_27_submit" class="btn_custom btn--medium btn--filledLight" type="submit">
                Enviar
              </button>
            </div>
